...
public class GameLevel implements Animation {
    ...
    public void initialize() {
        ...
        new Block(
                new Point(surface.getWidth() - MARGIN, 20),
                MARGIN,
                surface.getHeight(),
                new BlockBackground(Color.GRAY),
                0
        ).addToGame(this);

        //death region
        Block deadRegion = new Block(new Point(0, surface.getHeight()),
                surface.getWidth(),
                1,
                new BlockBackground(Color.GRAY), 0);
